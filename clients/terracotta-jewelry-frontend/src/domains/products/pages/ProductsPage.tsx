  ...
  return (
    <Box component={'main'}>
      ...
      >
        ...
        >
          Descubre nuestra colecci�n completa de arte en terracota
        </Typography>
      </Box>
            ...
            <Box display="flex" gap={2} flexDirection={{ xs: 'column', sm: 'row' }}>
              ...
              <FormControl sx={{ minWidth: 120, backgroundColor: '#FFF', borderRadius: '8px' }}>
                ...
                >
                  ...
                  <MenuItem value="over100">M�s de $100</MenuItem>
                </Select>
              </FormControl>
            </Box>
          </Grid2>
      ...
      >
        <Typography variant='h4' sx={{ color: '#FFF', mb: 2 }}>
          �Por qu� elegir TerraCotta?
        </Typography>
        <Typography variant='h6' sx={{ color: '#FFF', mb: 4 }}>
          Calidad artesanal y dise�os �nicos en cada pieza
        </Typography>
        <Grid2 container spacing={4} justifyContent="center">
          <Grid2 size={{ xs: 12, sm: 6, md: 3 }}>
            <Typography sx={{ fontSize: '24px', color: '#FFF' }}>Env�o gratuito mundial</Typography>
          </Grid2>
          <Grid2 size={{ xs: 12, sm: 6, md: 3 }}>
            <Typography sx={{ fontSize: '24px', color: '#FFF' }}>Garant�a de calidad</Typography>
          </Grid2>
          <Grid2 size={{ xs: 12, sm: 6, md: 3 }}>
            <Typography sx={{ fontSize: '24px', color: '#FFF' }}>Dise�os �nicos</Typography>
          </Grid2>
          <Grid2 size={{ xs: 12, sm: 6, md: 3 }}>
