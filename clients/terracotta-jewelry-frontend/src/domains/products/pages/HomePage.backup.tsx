...
const mockProducts: Product[] = [
	{
		id: '1',
		name: 'Anillo de Terracota',
		description: 'Hermoso anillo artesanal de terracota',
		price: 45.99,
	...
	{
		id: '2',
		name: 'Collar de Cerámica',
		description: 'Elegante collar de cerámica pintado a mano',
		price: 75.50,
	...
	{
		id: '3',
		name: 'Brazalete Artesanal',
		description: 'Brazalete único hecho a mano con técnicas tradicionales',
		price: 60.25,
